...
export default class PersonenDetails extends reloaderBase {
  ...
  addAK_config = [
    {
      ...
      rules: [
        (v:string) => (!v ? 'Es muss ein Arbeitskreis gewählt werden!' : true),
      ],
      required: true,
    },
    {
      ...
      componentName: 'ec-form-datePicker',
      rules: [
        (v:string) => (!v ? 'Es muss ein Eintrittsdatum angegeben werden!' : true),
      ],
      required: true,
    },
    {
  ...
  addTelefon_config = [
    {
      ...
      required: true,
      rules: [
        (v:string) => (!v ? 'Es muss eine Telefonnummer angegeben werden!' : true),
        (v:string) => (v && v.length > 20 ? 'Die Telefonnummer darf maximal 20 Zeichen lang sein!' : true),
      ],
    },
  ]
  addEmail_show = false
  addEmail_config = [
    {
      ...
      required: true,
      rules: [
        (v:string) => (!v ? 'Es muss eine E-Mail angegeben werden!' : true),
        (v:string) => (v && v.length > 20 ? 'Die Mail darf maximal 20 Zeichen lang sein!' : true),
      ],
    },
  ]
  ...
  addAdresse_config = [
    {
      ...
      required: true,
      rules: [
        (v:string) => (!v ? 'Es muss eine Straße angegeben werden!' : true),
        (v:string) => (v && v.length > 50 ? 'Die Straße darf maximal 50 Zeichen lang sein!' : true),
      ],
    },
    {
      name: 'plz',
      ...
      required: true,
      rules: [
        (v:string) => (!v ? 'Es muss eine PLZ angegeben werden!' : true),
        (v:string) => (v && v.length !== 5 ? 'Die Straße PLZ muss genau 5 Zeichen lang sein!' : true),
      ],
    },
    {
      name: 'ort',
      ...
      required: true,
      rules: [
        (v:string) => (!v ? 'Es muss ein Ort angegeben werden!' : true),
        (v:string) => (v && v.length > 50 ? 'Der Ort darf maximal 50 Zeichen lang sein!' : true),
      ],
    },
  ]
  tabs = null
  auskunftsRecht() {
    (<any>this.$apollo).getClient().query({
      query: gql`
  ...
  editAK_save(value: any) {
    this.$apollo.mutate({
      ...
      variables: {
        ...
        akID: value.ak,
        leiter: value.leiter === null ? false : value.leiter,
      },
    }).then(this.refetch);
  }
  ...
  addAdresse_save(value: any) {
    this.$apollo.mutate({
      mutation: gql`
        mutation($personID:Int!,$strasse:String!,$plz:String!,$ort: String!, $authToken: String!) {
          addAdresse(
            personID: $personID,
            strasse: $strasse,
            plz: $plz,
  ...
  addTelefon_save(value: any) {
    this.$apollo.mutate({
      mutation: gql`
        mutation($personID:Int!,$telefon:String!, $authToken: String!) {
          addTelefon(
            personID: $personID,
            telefon: $telefon,
            authToken: $authToken
  ...
  addEmail_save(value: any) {
    this.$apollo.mutate({
      mutation: gql`
        mutation($personID:Int!,$email:String!, $authToken: String!) {
          addEmail(
            personID: $personID,
            email: $email,
            authToken: $authToken
  ...
  editAdresse_save(value: any) {
    this.$apollo.mutate({
      mutation: gql`
        mutation($personID:Int!,$strasse:String!,$plz:String!,$ort: String!, $authToken: String!, $adressID:Int!) {
          editAdresse(
            adressID: $adressID,
            personID: $personID,
            strasse: $strasse,
  ...
  editTelefon_save(value: any) {
    this.$apollo.mutate({
      mutation: gql`
        mutation($personID:Int!,$telefon:String!, $authToken: String!, $telefonID: Int!) {
          editTelefon(
            telefonID: $telefonID,
            personID: $personID,
            telefon: $telefon,
  ...
  editEmail_save(value: any) {
    this.$apollo.mutate({
      mutation: gql`
        mutation($personID:Int!,$email:String!, $authToken: String!, $emailID: Int!) {
          editEmail(
            emailID: $emailID,
            personID: $personID,
            email: $email,
  ...
  editAdresse_open(item: {adressID: number, strasse: string, plz: string, ort: string}) {
    console.log(item)
  ...
  editTelefon_open(item: {telefonID: number, telefon:string}) {
